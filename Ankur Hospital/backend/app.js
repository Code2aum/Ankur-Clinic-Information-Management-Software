...
//Admin Queries
app.get('/Admin_Doctor',(req, res) => {
  let statement = `SELECT D.NAME,D.GENDER,D.EMAIL,S.SCHED FROM DOCTOR D, DOCSHAVESCHEDULES S WHERE D.EMAIL = S.DOCTOR `;
...
app.get('/Admin_appointment',(req, res) => {
...
app.get('/Admin_Patient_list',(req, res) => {
  let statement = `SELECT EMAIL,GENDER,NAME FROM PATIENT`;
  console.log(statement);
  con.query(statement, function (error, results, fields) {
    if (error) throw error;
    else {
...
app.get('/Admin_bookings',(req, res) => {
  let statement = `SELECT p.NAME,a.CONCERNS,a.SYMPTOMS,a.APPT FROM Patient p, PatientsAttendAppointments a where a.patient=p.email`;
  console.log(statement);
  con.query(statement, function (error, results, fields) {
    if (error) throw error;
    else {
...
app.post('/Admin_Update_Doctor',(req, res) => {
  let params = req.query;
  let email = params.email;
  let statement = `DELETE FROM DOCTOR WHERE EMAIL= "${email}"`;
  console.log(statement);
  con.query(statement, function (error, results, fields) {
    if (error) throw error;
    else {
...
app.post('/Admin_Update_Patient',(req, res) => {
  let params = req.query;
  let email = params.email;
  let statement = `DELETE FROM PATIENT WHERE EMAIL= "${email}"`;
  console.log(statement);
  con.query(statement, function (error, results, fields) {
    if (error) throw error;
    else {
